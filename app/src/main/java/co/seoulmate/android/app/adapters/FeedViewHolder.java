...
public class FeedViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private static final String LOG_TAG = FeedViewHolder.class.getSimpleName();
    ...
    public FeedViewHolderClicks mListener;

    public FeedViewHolder(View v, TextView title, TextView time, Button tagIcon
            , TextView vote, TextView writer, ImageButton voteIcon,
                          LinearLayout linearLayout, RoundedImageView pic,ImageView status,
                          FeedViewHolderClicks listener
    ) {
        super(v);
        mListener = listener;
        mTitleView = title;
    ...
    public static interface FeedViewHolderClicks {
