                ...
                photo.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if(e == null) {
                            ...
                            question.setCategory(mCategory);
...
*//*                            acl.setRoleWriteAccess("Moderators", true);
                            ...
                            question.setACL(acl);
                            question.setUser(ParseUser.getCurrentUser());
                            question.saveInBackground(new SaveCallback() {
                                @Override
                                public void done(ParseException e) {
                                    if (e == null) {
                                        Log.d(LOG_TAG, "question post saved successfully | with Image!");
                                        progress.setVisibility(View.GONE);
                                        showFinishToast();
                                        submit.setEnabled(true);
                                        question.pinInBackground(ModelUtils.BOARD_PIN);
                                    } else {
                                        ...
                                        progress.setVisibility(View.GONE);
                                        submit.setEnabled(true);
                                        Log.d(LOG_TAG, "question post -  exception :" + e.getMessage());
                                    }
                                }
                            });
                        }
                ...
                question.setTitle(title);
                if(content != null)
                    question.setUniversity(content);
                question.setCategory(mCategory);
                question.setSolvedStatus(false);
                question.setPosition(25);
//                question.setIsSolved(false);
                ParseACL acl = new ParseACL();
                acl.setPublicReadAccess(true);
                acl.setPublicWriteAccess(true);
//                acl.setRoleWriteAccess("Moderators", true);
                ...
                question.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e == null) {
                            Log.d(LOG_TAG, "question post saved successfully!");
                            progress.setVisibility(View.GONE);
                            Log.d(LOG_TAG, "Saved in Background question in cat " + mCategory);
                            showFinishToast();
                            submit.setEnabled(true);
                            question.pinInBackground(ModelUtils.FEED_PIN);
                        } else {
                            mTitle.setVisibility(View.VISIBLE);
                            mContent.setVisibility(View.VISIBLE);
/*                            insertLink.setVisibility(View.VISIBLE);
    ...
    private void showFinishToast() {
        ...
        Intent intent = new Intent(NewQuestionActivity.this, DispatchActivity.class);
